...
namespace Downla.Controller.Interfaces
{
    public interface IM3U8Controller
    {
        ...
        Task StartDownloadVideoAsync(Uri url, int maxConnections, string fileName, int startConnectionDelay, out DownloadMonitor downloadMonitor, CancellationToken ct = default);
